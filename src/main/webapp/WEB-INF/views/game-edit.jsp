...
<form action="" id="form_2">
    <div class="control-group control-group1" id="">
        ...
        <img src="<%=request.getContextPath()%>/file/${game.imgpath}" name="file" id="yushow" class="sh2"/>
    </div>
    ...
    <div class="row">
        <div class="control-group">
            ...
            <input type="text"  name="title" class="control-text" value="${game.title}">
        </div>
    </div>
    <div class="row">
        <div class="control-group">
            <label class="control-label">url：</label>
            <input type="text"  name="url" class="control-text" value="${game.url}">
        </div>
    </div>
    <div class="row">
        <div class="control-group">
            <label class="control-label">更多：</label>
            <input type="text"  name="more" class="control-text" value="${game.more}">
        </div>
    </div>
...
<script>
    $(document).ready(function(){
    	$("#form_2").append('<input type="hidden" name="id" value="${game.id}">');
    	$("#form_2").prepend('<input type="hidden" id="file" name="saveFilename" value="${game.imgpath}">');
        $('#submit').eq(0).click(function(){
                $.ajax({
                    url:'/website/Controller/gameAlter',
                    type:"POST",
                    ...
                    success: function(data) {
                        if(data.message="成功"){
                            ...
                            window.location.href="/website/Controller/game";                            
                        }else{
