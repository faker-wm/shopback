...
<form action="" id="form_2">
    <div class="control-group control-group1" id="">
        ...
        <img src="<%=request.getContextPath()%>/file/${about.imgpath}" name="file" id="yushow" class="sh2"/>
    </div>
    ...
    <div class="row">
        <div class="control-group">
            ...
            <input type="text"  name="title" class="control-text" value="${about.title}">
        </div>
    </div>
    <div class="row">
        <div class="control-group">
            <label class="control-label">内容：</label>
            <input type="text"  name="url" class="control-text" value="${about.url}">
        </div>
    </div>
...
<script>
    $(document).ready(function(){
    	$("#form_2").append('<input type="hidden" name="id" value="${about.id}">');
    	$("#form_2").prepend('<input type="hidden" id="file" name="saveFilename" value="${about.imgpath}">');
        $('#submit').eq(0).click(function(){
                $.ajax({
                    url:'/website/Controller/aboutAlter',
                    type:"POST",
                    ...
                    success: function(data) {
                        if(data.message="成功"){
                            ...
                            window.location.href="/website/Controller/about";                            
                        }else{
