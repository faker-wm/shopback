...
<div class="doc-content">
    ...
    <table cellspacing="0" class="table table-head-bordered table-bordered">
        <a href="/website/Controller/moreAdd">
            <div class="s-btn">
        ...
        <tr>
            ...
            <td>${obj.title}</td>
            <td>${obj.key}</td>
            <td><a href="/website/Controller/moreselectById?id=${obj.id}">编辑</a>
             <a href="/website/Controller/moreDelete?id=${obj.id}">删除</a></td>
        </tr>        
...
function page(i){
	...
	//跳转路径再次查询分页数据
	window.location.href="MoreSelect?currentPage="+i+"&pageSize="+pageSize+" "
}
</script>
<!-- 获取分页的html代码进行显示-->
${page}
