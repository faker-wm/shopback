...
<form action="" id="form_2">
    <div class="control-group control-group1" id="">
        ...
        <img src="<%=request.getContextPath()%>/file/${other.imgpath}" name="file" id="yushow" class="sh2"/>
    </div>
    ...
    <div class="row">
        <div class="control-group">
            ...
            <input type="text"  name="title" class="control-text" value="${other.title}">
        </div>
    </div>
    <div class="row">
        <div class="control-group">
            <label class="control-label">url：</label>
            <input type="text"  name="url" class="control-text" value="${other.url}">
        </div>
    </div>
...
<script>
    $(document).ready(function(){
    	$("#form_2").append('<input type="hidden" name="id" value="${other.id}">');
    	$("#form_2").prepend('<input type="hidden" id="file" name="saveFilename" value="${other.imgpath}">');
        $('#submit').eq(0).click(function(){
                $.ajax({
                    url:'/website/Controller/otherAlter',
                    type:"POST",
