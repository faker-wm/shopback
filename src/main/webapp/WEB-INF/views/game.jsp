...
<div class="doc-content">
    ...
    <table cellspacing="0" class="table table-head-bordered table-bordered">
        <a href="/website/Controller/gameAdd">
            <div class="s-btn">
        ...
        <tr>
            ...
            <td>${obj.url}</td>
            <td>${obj.title}</td>
            <td><a href="/website/Controller/gameselectById?id=${obj.id}">编辑</a>
             <a href="/website/Controller/gameDelete?id=${obj.id}">删除</a></td>
        </tr>        
...
function page(i){
	...
	//跳转路径再次查询分页数据
	window.location.href="GameSelect?currentPage="+i+"&pageSize="+pageSize+" "
}
</script>
<!-- 获取分页的html代码进行显示-->
${page}
